...
public class ReadFileTest {
    ...
    public void testReadFileOrders_ifNotNull() {
        ...
        try {
            jsonArray = ReadFile.readFileOrders("..\\ocado_task1\\testData\\orders.json");
    ...
    public void testReadFileOrders_ifWrongPath() {
        JSONArray jsonArray = null;
        try {
            jsonArray = ReadFile.readFileOrders("..\\ocado_task1\\testData\\oders.json");
        } catch (IOException | ParseException e) {
            System.out.println(e.getMessage());
        }
    ...
    @Test
    public void testReadFileOrders_ifContainsTwoElements() {
        int actualSize = 0;
        try {
            JSONArray jsonArray = ReadFile.readFileOrders("..\\ocado_task1\\testData\\orders.json");
    ...
    public void testReadFileStore_ifNotNull() {
        ...
        try {
            jsonObject = ReadFile.readFileStore("..\\ocado_task1\\testData\\store.json");
        } catch (IOException | ParseException e) {
            System.out.println(e.getMessage());
        }
    ...
    public void testReadFileStore_ifWrongPath() {
        JSONObject jsonObject = null;
        try {
            jsonObject = ReadFile.readFileStore("..\\ocado_task1\\testData\\stre.json");
        } catch (IOException | ParseException e) {
            System.out.println(e.getMessage());
        }
        String expected = null;
    ...
    @Test
    public void testReadFileStore_ifContainsOnePicker() {
        Object actualPickers = null;
        try {
            JSONObject jsonObject = ReadFile.readFileStore("..\\ocado_task1\\testData\\store.json");
    ...
    public void testReadOrders_ifNotNull() {
        ...
        try {
            orders = ReadFile.readOrders("..\\ocado_task1\\testData\\orders.json");
        } catch (IOException | ParseException e) {
            System.out.println(e.getMessage());
        }
    ...
    public void testReadOrders_ifCorrectOrdersNumber() {
        int actualSize = 0;
        try {
            List<Order> orders = ReadFile.readOrders("..\\ocado_task1\\testData\\orders.json");
    ...
    public void testReadOrders_ifWrongPath() {
        List<Order> orders = null;
        try {
            orders = ReadFile.readOrders("..\\ocado_task1\\testData\\orers.json");
        } catch (IOException | ParseException e) {
            System.out.println(e.getMessage());
        }
    ...
    public void testReadStore_ifNotNull() {
        ...
        try {
            pickers = ReadFile.readStore("..\\ocado_task1\\testData\\store.json");
        } catch (IOException | ParseException e) {
            System.out.println(e.getMessage());
        }
    ...
    public void testReadStore_ifCorrectPickersNumber() {
        int actualSize = 0;
        try {
            Queue<Picker> pickers = ReadFile.readStore("..\\ocado_task1\\testData\\store.json");
    ...
    public void testReadStore_ifWrongPath() {
        Queue<Picker> pickers = null;
        try {
            pickers = ReadFile.readStore("..\\ocado_task1\\testData\\stre.json");
        } catch (IOException | ParseException e) {
            System.out.println(e.getMessage());
        }
